          ...
          <div>
            ...
            <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
              <p className="text-2xl font-semibold">
                {listing.name} - ₹{' '}{ listing.regularPrice }{ listing.type === "Rent" && "/ month" }
              </p>
              ...
              {
                currentUser && listing.referenceId !== currentUser._id && !contact && 
                ( <button onClick={() => setContact(true)} className="bg-slate-700 text-white rounded-lghover:opacity-95 p-3">CONTACT LANDLORD</button> )
              }
